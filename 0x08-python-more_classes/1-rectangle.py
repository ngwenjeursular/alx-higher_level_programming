...
class Rectangle:
    """
    defines a rectangle using: Private instance attribute: width, height
    Which are the two arguments

    Args:
        width(int) : measure of one of the two parallel sides
        height(int) : measure of the other vertial side
